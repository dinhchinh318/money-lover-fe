...
import { Mail, Lock, Eye, EyeOff, Wallet, CheckCircle2, ShieldCheck, Sparkles, TrendingUp, ArrowRight } from "lucide-react";
...
const Login = () => {
  ...
  // --- Logic Giữ Nguyên (Google Script & Callbacks) ---
  useEffect(() => {
        ...
        <div className="w-full max-w-5xl bg-white rounded-[2.5rem] shadow-[0_20px_70px_rgba(0,0,0,0.08)] overflow-hidden flex flex-col md:flex-row min-h-[700px] relative z-10 border border-white">
          ...
          <div className="w-full md:w-1/2 p-8 lg:p-14 flex flex-col justify-center">
            <div className="mb-10">
              ...
              <p className="text-slate-500 text-base font-medium">Nhập thông tin để tiếp tục quản lý tài chính.</p>
            </div>
            ...
            >
              ...
              <div className="flex items-center justify-between pb-2">
                ...
                <Link to="/forgot-password" virtual="true" className="text-sm font-bold text-emerald-600 hover:text-emerald-700 transition-all hover:underline underline-offset-4">
                  Quên mật khẩu?
                </Link>
              </div>
              ...
              <div className="relative my-8">
                ...
                <div className="relative flex justify-center text-xs uppercase"><span className="bg-white px-4 text-slate-400 font-bold tracking-widest">HOẶC</span></div>
              </div>
              ...
              <p className="text-center text-slate-500 font-medium mt-10">
                Chưa có tài khoản?{' '}
                <Link to="/register" className="text-emerald-600 font-black hover:text-emerald-700 underline-offset-4 hover:underline">Đăng ký miễn phí</Link>
              </p>
            </Form>
          </div>
            ...
            <div className="relative z-10 w-full max-w-sm">
              <div className="bg-white/10 backdrop-blur-2xl border border-white/20 rounded-[2.5rem] p-10 shadow-3xl">
                <div className="mb-10">
                  ...
                  <p className="text-emerald-100/70 text-lg font-medium leading-relaxed">Tiết kiệm thông minh hơn, sống an tâm hơn cùng MoneyWise.</p>
                </div>
                ...
                <div className="mt-12 bg-white rounded-3xl p-6 shadow-[0_30px_60px_-15px_rgba(0,0,0,0.3)] transform rotate-3 hover:rotate-0 transition-all duration-700 cursor-pointer group">
                  <div className="flex justify-between items-start mb-4">
                    <div className="w-10 h-10 bg-slate-100 rounded-full flex items-center justify-center font-bold text-slate-400 text-xs">MW</div>
              ...
              <div className="mt-10 flex justify-center">
                <div className="inline-flex items-center gap-2 px-5 py-2.5 bg-white/5 rounded-full border border-white/10 backdrop-blur-md">
                  ...
                  <span className="text-[12px] text-emerald-100 font-bold tracking-wide uppercase">Secure Bank-Level AES 256</span>
                </div>
              </div>
            </div>
          </div>
