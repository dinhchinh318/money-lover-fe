...
const FIELD_ORDER = ["displayName", "gender", "dateOfBirth", "email", "phone", "address", "bio"];
...
const ProfilePage = () => {
  ...
  const displayName = uiValues.displayName || rawProfile?.displayName || t("profile.fallback.displayName");
